...
class HomePanel extends JPanel implements ActionListener
{
    ...
    public HomePanel(GeoMonsters frame, CardLayout cardLayout)
    {
        ...
        titleLabel.setFont(new Font("SansSerif", Font.BOLD, 48)); //serif lowkey looking a bit weird we can change this
        ...
        myTeamButton.setPreferredSize(new Dimension(75, 75));  //square
